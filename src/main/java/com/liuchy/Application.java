...
//        MessageListener messageListener = new MessageListener(mnsProperties.getAccessId(), mnsProperties.getAccessKey(), mnsProperties.getEndPoint(), mnsProperties.getMessageQueue());
//        messageListener.run();
    }
}
